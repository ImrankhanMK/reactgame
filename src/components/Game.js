  ...
  const scoreCard = (e) => {
    navigate("/score_card", {
      state: {
        ...
        level: level,
        score: score,
        winnings: garage.length,
        rating: rating,
        complete: isGameCompleted,
      },
    });
  };
      ...
      <div id="game" className="game-main">
        {gameOver ? (
          ...
          <div className="game-track">
            ...
            <div>
              <p className="level-indicator" ref={indicatorRef}>
                level {level}
              </p>
            </div>
          </div>
          ...
          <div>
            <div className="border text-white mt-3 ">
              ...
              {garage.length === 0 ? (
                ...
                <div
                  className="d-flex bg-black garage"
                  style={{ height: "80px" }}
                >
                  {garage.map((item, key) => (
                    <div>
